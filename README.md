...
<div align="center">
<h1> <b>Test Driven Development</b> <hr/>
...
> ## In the **TDD**  project we implement a `Solver` class with some methods by using Test-driven Development (TDD) approach. As such, we wrote the tests first and then implemented the methods to pass the tests.
...
```sh
  cd my-folder
  git clone github.com/LoviMadaan/TDD
```
...
- [ ] To add more methods to the Solver class and cover it with more unit tests.
...
Feel free to check the [issues page](https://github.com/LoviMadaan/TDD/issues).
